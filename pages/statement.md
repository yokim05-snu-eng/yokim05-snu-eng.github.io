    ...
    <div class="stmt-dark-letter-inner">
      ...
      <div class="stmt-lang-content" data-lang-content="ko">
        ...
        <div class="stmt-dark-body">
          ...
          <p>이런 점에서 볼 때 저는 운이 좋은 사람입니다. 제 임기 중 이런 흐름이 더 강해졌기 때문입니다. 저는 서울공대의 이름으로, 서울공대의 힘으로, 그 흐름을 강화하고 또 올라타려고 안간힘을 썼습니다. 이제는 외람되지만 이렇게 말씀드릴 수 있습니다. "우리는 스스로 변화함으로써 세계의 변화를 선도하고 있습니다."</p>
          ...
          <p>서울대학 내 살림살이도 놓치지 않았습니다. 단과대학으로는 드물게 2년 연속 신축 건물 예산(총 예산 <strong>국고 700억원, 민간 300억원</strong>)이 본부를 통과 중이며, 교원 확보와 강의 책임시수 완화에도 실질적 소득이 있었습니다. 특히 2025년에 저는 전국 공과대학을 대상으로 수여하는 '최우수학장상'을 수상하였고, 우리 공대는 <strong>서울대학교 '최우수 행정기관'</strong>으로 선정되었습니다.</p>
...
document.addEventListener('DOMContentLoaded', function () {
  // Determine initial language from URL param > localStorage > default 'ko'
  var params = new URLSearchParams(window.location.search);
  var initialLang = params.get('lang') || localStorage.getItem('siteLang') || 'ko';

  function setLang(lang, updateUrl) {
    document.querySelectorAll('.stmt-lang-btn').forEach(function (b) {
      b.classList.toggle('is-active', b.getAttribute('data-lang') === lang);
    });
    document.querySelectorAll('.stmt-lang-content').forEach(function (c) {
  ...
  document.querySelectorAll('.stmt-lang-btn').forEach(function (btn) {
